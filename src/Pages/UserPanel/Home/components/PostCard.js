          ...
          <div className="bg-gray-00  p-4">
            <div className="bg-white border rounded-sm max-w-2xl">
              <div className="flex items-center px-4 py-3">
                <img className="h-14 w-14 rounded-full" src={data?.userImage}/>
                <div className="ml-3 ">
                  <span className="text-sm font-semibold antialiased block leading-tight">{data?.userName}</span>
              ...
              <div className="flex items-center justify-between mx-4 mt-3 mb-2">
                ...
                <div className="font-semibold text-sm mx-4 mt-2 mb-4">{totalLikes.length} Likes  </div>
            </div>
          </div>
    );
}
